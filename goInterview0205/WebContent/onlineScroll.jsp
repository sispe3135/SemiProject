		...
		<div class="scroll-box">
			<div class="scroll-box-tbl">
				...
				<div class="scroll-rgt">
					<span><%=dto.getChatTitle() %></span>
					<br/><br/>
					<span><%=dto.getChatNum() %></span>
					<br/><br/>
					<span><%=dto.getChatNum() %></span>
					<br/><br/>
					<span><%=dto.getChatStDt() %></span>
					<br/><br/>
					<span><%=dto.getChatMgr() %></span>
				</div>	
			</div>
			<button class="mbr-btn" onclick="location.href='onlineChatJoin'">&nbsp; Join </button>
		</div>
<%	
		} 
	}
