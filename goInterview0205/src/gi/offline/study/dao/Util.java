...
public class Util {
	...
	public static String getCalView(int i, List<giStudyDto> clist) {

	//	String d = isTwo(i + "");
		String d= isTwo(Integer.toString(i));
		String res = "";

		for (giStudyDto dto : clist) {
			if (dto.getStdDt().substring(6, 8).equals(d)) {
				res += "<p>" + ((dto.getStdTitle().length() > 6) ? dto.getStdTitle().substring(0, 6) + "..." : dto.getStdTitle())
						+ "</p>";
			}
		}
	...
	// stdmbrdto를 받아서 뿌려주는 함수
	public static String getCalViewOffline(int i, List<giStdMbrDto> clist) {
	...
	// giOnlineDto를 받아서 뿌려주는 함수
	public static String getCalViewOnline(int i, List<giOnlineDto> clist) {
